...
| Verdier duality | Poincaré duality as a triangulated self-equivalence; f! as the exceptional inverse image; intersection cohomology as a stable object | Kashiwara–Schapira, BBD |

### Homotopy-Theoretic Perspective

| Subtopic | Key Idea | Primary Source |
|----------|----------|----------------|
| t-structures | Axiomatize a "truncation" on a triangulated cat; the heart is abelian; Postnikov sections in spectra are the canonical example | BBD, Mathew blog |
| Weight structures | Bondarko's dual notion to t-structures; a "weight filtration" on objects; ubiquitous in motivic homotopy theory and geometric representation theory | Bondarko (arXiv:0704.4003) |
| Model categories | Quillen's framework for homotopical algebra; weak equivalences + fibrations + cofibrations; the homotopy category Ho(M) generalizes D(A); cofibrant/fibrant replacements = resolutions | Hovey, Quillen |
| Spectra and SH | The stable homotopy category SH is the "universal" triangulated cat generated by S⁰; D(Ab) ≃ HZ-mod via Eilenberg–MacLane; smash product ↔ ⊗ᴸ | Adams, Ravenel, Lurie HA |
| Stable ∞-categories | The ∞-categorical fix for triangulated cats: cones are functorial, the octahedral axiom is automatic; every triangulated cat arises as Ho(C) for a stable ∞-cat C | Lurie "Higher Algebra" |
...
flowchart TD
    ...
    E["Verdier Duality<br/>verdier-duality.md"]
    F["t-structures and Weight Structures<br/>t-structures-weight-structures.md"]
    G["Model Categories<br/>model-categories.md"]
    H["Spectra and SH<br/>spectra.md"]
    I["Stable infinity-Categories<br/>stable-infinity-categories.md"]
...
| "Homotopical Algebra" | D. G. Quillen | 1967 | The original source for model categories; introduces the axioms (MC1–MC5), homotopy category Ho(M), derived functors of Quillen pairs, and the model structure on simplicial sets | [Springer LNM 43](https://link.springer.com/book/10.1007/BFb0097438) |
| "Model Categories" | M. Hovey | 1999 | Graduate textbook on model categories; includes the projective and injective model structures on chain complexes (recovering D(A)), and Quillen's theorem on simplicial sets | [AMS](https://www.ams.org/books/surv/063/) · [Author PDF](https://people.math.rochester.edu/faculty/doug/otherpapers/hovey-model-cats.pdf) |
| "Stable Homotopy and Generalised Homology" | J. F. Adams | 1974 | The foundational text for stable homotopy theory; introduces spectra (in the sense of Adams), the stable homotopy category, and the Adams spectral sequence | [University of Chicago Press](https://press.uchicago.edu/ucp/books/book/chicago/S/bo3628148.html) |
| "Higher Algebra" | J. Lurie | 2017 | Defines stable ∞-categories (Ch. 1); establishes that they are the correct homotopy-coherent replacement for triangulated categories; constructs the ∞-category of spectra; develops ∞-categorical derived algebra | [Author website PDF](https://www.math.ias.edu/~lurie/papers/HA.pdf) |
| "Weight structures vs. t-structures; weight filtrations, spectral sequences, and complexes" | M. V. Bondarko | 2010 | Introduces weight structures (the "dual" notion to t-structures); weight filtrations and weight spectral sequences; applications to motivic cohomology and geometric representation theory | [arXiv:0704.4003](https://arxiv.org/abs/0704.4003) |
| "Introduction to Infinity-Categories" | M. Land | 2021 | Accessible graduate-level introduction to ∞-categories (quasi-categories), stable ∞-categories, and their relationship to triangulated categories and spectra | [Springer Compact Textbooks](https://link.springer.com/book/10.1007/978-3-030-61524-6) |
