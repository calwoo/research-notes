...
> where $B_1(\mathbf{B}\Sigma)$ denotes the first delooping in the spectrum. The group completion of $\pi_0|\hat{\Sigma}(\mathbf{1})| = \mathbb{N}$ is $\mathbb{Z}$, consistent with $\pi_0(\mathbb{S}) = \mathbb{Z}$. **The BPQ theorem promotes this $\pi_0$-level computation to a full equivalence of spectra.**
>
