...
> For continuous distributions, the analogue of Shannon entropy is *differential entropy* $h(X) = -\int p(x)\log p(x)\,dx$. Unlike $H(X)$, $h(X)$ can be negative and is not invariant under reparametrisation. However, $D_{\mathrm{KL}}(P \,\|\, Q) = h(P,Q) - h(P)$ where $h(P,Q) = -\int p(x)\log q(x)\,dx$ is the *cross-entropy*, and this relation holds with the same sign conventions as the discrete case.
...
> [!QUESTION] Exercise 3: Non-Symmetry of KL via Explicit Computation
...
> [!QUESTION] Exercise 4: KL Divergence Between Gaussians
...
> [!QUESTION] Exercise 5: Mutual Information and Correlation
...
> [!QUESTION] Exercise 6: Data Processing for Deterministic Functions
...
> [!QUESTION] Exercise 7: Chain Rule for Mutual Information
...
> [!QUESTION] Exercise 8: Hellinger Distance and Batacharyya Coefficient
...
> [!QUESTION] Exercise 9: Convexity of KL in the First Argument
...
> [!QUESTION] Exercise 10: Applying the Log-Sum Inequality
...
> [!QUESTION] Exercise 11: Fano's Inequality Applied
...
> [!QUESTION] Exercise 12: Pinsker for Gaussians
> *This problem applies Pinsker's inequality to Gaussians and checks whether the bound is useful.*
>
> > **Prerequisites:** [[#5.5 Pinsker's Inequality|5.5 Pinsker's Inequality]], [[#2.4 Operational Meaning: Log-Likelihood Ratios and Stein's Lemma|2.4 KL Between Gaussians (Exercise 4)]]
>
...
> [!QUESTION] Exercise 14: Conditioning Cannot Increase Mutual Information
...
> [!QUESTION] Exercise 15: The KL Chain Rule and Bayes
...
> [!QUESTION] Exercise 16: Subadditivity and Independence Testing
...
> [!QUESTION] Exercise 17: Computing Entropy via NumPy
...
> [!QUESTION] Exercise 18: Estimating Mutual Information from Samples
...
> [!QUESTION] Exercise 19: KL Divergence via Importance Sampling
...
> [!QUESTION] Exercise 20: Computing the f-Divergence Table Entry for Pearson Chi-Squared
...
> [!QUESTION] Exercise 21: Entropy Rate Estimation for Markov Chains
