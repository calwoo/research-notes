...
![SimCLR general architecture](figures/simclr-general-architecture.png)
...
![SimCLR augmentation pipeline](figures/simclr-random-transformation-function.gif)
...
![SimCLR batch data preparation](figures/simclr-batch-data-preparation.png)
...
![SimCLR pairwise similarity matrix](figures/simclr-pairwise-similarity.png)
...
![SimCLR softmax loss](figures/simclr-softmax-loss.png)
...
![SimCLR encoder](figures/simclr-encoder-part.png)
...
![SimCLR projection head](figures/simclr-projection-head-component.png)
...
![SimCLR performance results](figures/simclr-performance.png)
...
![SimCLR downstream tasks](figures/simclr-downstream.png)
